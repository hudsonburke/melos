...
MYOFULLBODY_TO_HUMAN_V1 = TranslationMap(
    ...
    rules=[
        ...
        SegmentTranslationRule(segment_id="left_shoulder_girdle", source_link_id="clavicle_l", target_link_id="left_shoulder_girdle", source_tail_link_id="humphant1_l", parent_segment_id="thorax", target_joint_ids=["Chest", "LeftShoulder"], reference_target_joint_ids=["Chest", "LeftArm"], anchor_target_joint_id="LeftShoulder", template_ref_dir=(-1.0, 0.0, 0.0)),
        SegmentTranslationRule(segment_id="left_upper_arm", source_link_id="humerus_l", target_link_id="left_upper_arm", source_tail_link_id="ulna_l", parent_segment_id="left_shoulder_girdle", target_joint_ids=["LeftShoulder", "LeftArm"], anchor_target_joint_id="LeftArm", template_ref_dir=(-1.0, 0.0, 0.0)),
        SegmentTranslationRule(segment_id="left_forearm", source_link_id="ulna_l", target_link_id="left_forearm", source_tail_link_id="lunate_l", parent_segment_id="left_upper_arm", target_joint_ids=["LeftArm", "LeftForeArm"], reference_target_joint_ids=["LeftForeArm", "LeftHand"], anchor_target_joint_id="LeftForeArm", template_ref_dir=(0.0, 0.0, -1.0)),
        SegmentTranslationRule(segment_id="left_hand", source_link_id="radius_l", target_link_id="left_hand", source_tail_link_id="lunate_l", parent_segment_id="left_forearm", target_joint_ids=["LeftForeArm", "LeftHand"], anchor_target_joint_id="LeftHand", reduction_mode="inherit_parent", failure_policy="inherit", template_ref_dir=(0.0, 0.0, -1.0)),
        SegmentTranslationRule(segment_id="right_shoulder_girdle", source_link_id="clavicle_r", target_link_id="right_shoulder_girdle", source_tail_link_id="humphant1_r", parent_segment_id="thorax", target_joint_ids=["Chest", "RightShoulder"], reference_target_joint_ids=["Chest", "RightArm"], anchor_target_joint_id="RightShoulder", template_ref_dir=(1.0, 0.0, 0.0)),
        SegmentTranslationRule(segment_id="right_upper_arm", source_link_id="humerus_r", target_link_id="right_upper_arm", source_tail_link_id="ulna_r", parent_segment_id="right_shoulder_girdle", target_joint_ids=["RightShoulder", "RightArm"], anchor_target_joint_id="RightArm", template_ref_dir=(1.0, 0.0, 0.0)),
        SegmentTranslationRule(segment_id="right_forearm", source_link_id="ulna_r", target_link_id="right_forearm", source_tail_link_id="lunate_r", parent_segment_id="right_upper_arm", target_joint_ids=["RightArm", "RightForeArm"], reference_target_joint_ids=["RightForeArm", "RightHand"], anchor_target_joint_id="RightForeArm", template_ref_dir=(0.0, 0.0, -1.0)),
        SegmentTranslationRule(segment_id="right_hand", source_link_id="radius_r", target_link_id="right_hand", source_tail_link_id="lunate_r", parent_segment_id="right_forearm", target_joint_ids=["RightForeArm", "RightHand"], anchor_target_joint_id="RightHand", reduction_mode="inherit_parent", failure_policy="inherit", template_ref_dir=(0.0, 0.0, -1.0)),
